...
listing:
  - id: rposts
    template: single_page/posts_papers.ejs
    contents: [posts]
    max-items: 5
    sort: "date desc"
    categories: false
    fields: [date, title, description, categories, image, threeword, outputHref, ispost, tweetthread, relatedpost, relatedpaper, news, demo, demo, repo]
    feed: false
    filter-ui: false
    sort-ui: false
    ...
    exclude:
      title: "Posts"
  - id: rupdates
    template: about_me/updates_about.ejs
    contents: 
