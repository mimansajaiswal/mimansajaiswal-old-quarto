...
2.  Use [astro to notion](https://github.com/otoyo/astro-notion-blog), if you want to write in Notion, and are okay setting up github actions once for automatic deployment.
