...
3.  [Git Based CMS] if you want to host the static site elsewhere, but sync the content (editable in wysiwyg) with github.
...
![Screenshot of website made in montaigne](images/screenshot of montaigne website.png){fig-alt="Screenshot of website made in montaigne" width="707"}
...
![Screenshot of example website made in Quarto](images/screenshot of quarto website.png){fig-alt="Screenshot of example website made in Quarto" width="710"}
