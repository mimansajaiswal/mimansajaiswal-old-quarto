...
-   For tasks, I use [Todoist](https://todoist.com/). I have used 100 other apps, but I keep coming back to Todoist. With their quick capture being all hashbang based, nothing is easier for me to quick capture, schedule, rescheduled, completed. It syncs with Google Calendar. It works in collaboration mode. This is the only task tracker that has worked for me.